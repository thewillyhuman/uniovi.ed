...
public class GenericDataStructure<T extends Comparable<T>> {
	...
	/**
	 * default toString method. In order to print all the elements in the collection.
	 */
	@Override
	...
	/**
	 * CompareTwoElements method that compares two elements given their array positions.
	 * 
