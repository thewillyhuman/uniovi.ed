package com.guille.ed.algorithmics;
...
public class TestBench {
	 ...
	 * System.out.println("Algorithm..." + ALGORITHMS[i]); if(i==2 || i==7)
	 * { TestBench.test(ALGORITHMS[i]+"_means.csv", ALGORITHMS[i], START_N,
	 * 12, SAMPLES); //Override for the exponential version. } else {
	 * TestBench.test(ALGORITHMS[i]+"_means.csv", ALGORITHMS[i], START_N,
	 * FINAL_N, SAMPLES); } }
	 */
	TestBench.test("com.guille.ed.algorithmics.", "GraphPerformanceTest", "01_Graph_Floyd.csv", "runFloyd", START_N,
		FINAL_N, SAMPLES);
	TestBench.test("com.guille.ed.algorithmics.", "GraphPerformanceTest", "02_Graph_Dijkstra.csv", "runDijkstra",
		START_N, FINAL_N, SAMPLES);
	TestBench.test("com.guille.ed.algorithmics.", "GraphPerformanceTest", "03_Graph_Build.csv", "initGraph",
		START_N, FINAL_N, SAMPLES);

    }

    /**
     * DEPRECATED Old and deprecated test method.
     * 
     * @param n
     *            long, represents the workload.
     */
     ...
     *             file.
     */
    private static void test(String path, String classTo, String fileName, String algorithmName, int startN, int endN,
     ...
     * 
     * @param String
     *            className, the name of the class the method you want to
     *            execute is placed.
     * @param String
     *            methodName, the name of the method you want to test.
     * @param int
     *            n.
     */
     ...
     * 
     * @param i
     *            the current iteration, just to print.
     */
