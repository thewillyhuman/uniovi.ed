...
public class L7_BST_EvalTest {
	...
	assertEquals("2(1)1(0)--5(0)3(0)--7(0)--", a.joins(a).toString());
	assertEquals("7(0)6(0)--8(0)--", b.joins(b).toString());
	...
	assertEquals("5(0)2(0)1(0)--3(0)--7(0)6(0)--8(0)--", a.joins(b).toString());
	assertEquals("3(1)1(1)-2(0)--7(-1)6(-1)5(0)---8(0)--", b.joins(a).toString());
    }
