 ...
 * @version 2.3
 * @param <T>
 *            Type of data that the structure will contain.
 */
public class AVLTree<T extends Comparable<T>> {
     ...
     * 
     * @param root
     *            AVLNode to be the root of the tree.
     */
     ...
     * @throws Exception
     *             if the the element is null or if it's already in the tree.
     */
     ...
     * @throws Exception
     *             if the element already exists or if it's null.
     */
     ...
     * @throws Exception
     *             if you try to delete a null, empty or non existent node.
     */
     ...
     *            the element to be deleted
     * @param root
     *            where you start to look for the node
     ...
     * 
     * @param tree.
     *            Second tree of the composition.
     ...
     * 
     * @param root
     *            where you start to perform the algorithm
     ...
     * 
     * @param tree
     *            that will be the auxiliary one.
     * @param root
     *            to start working to make the copy.
     * @return the aux tree.
     */
     ...
     * 
     * @param secondTree
     *            is the second AVLTree to get the different elements.
     ...
     * 
     * @param element
     *            is the element we are going to use to compare with the
     ...
     * 
     * @param root
     *            is the current element where we iterate.
     * @param key
     *            is the given element to make the condition.
     * @return the number of elements that are grater that the element given as
     *         a parameter.
     */
