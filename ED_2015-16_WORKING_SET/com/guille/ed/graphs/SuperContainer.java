...
public class SuperContainer<T, K> {
     ...
     * 
     * @param Container
     *            of T type. K info and and integer with the key.
     */
     ...
     * 
     * @param infor
     *            k type. The information that will be stored in the info
     *            property.
     */
     ...
     * 
     * @param integer
     *            key that will be the value to store in the key property.
     */
