...
public class HashTable<T extends Comparable<T>> {
     ...
     *            type of re dispersion that is going to be used.
     * @param minLF
     *            the minimum load factor accepted.
     */
     ...
     * 
     * @param minLF,
     *            the minimum accepted load factor for the hash table.
     */
     ...
     * 
     * @param number
     *            where you start to check for the next prime number
     ...
     * 
     * @param i
     *            number to start looking for prime numbers.
     ...
     * 
     * @param number
     *            where you start to check for the previous prime number
