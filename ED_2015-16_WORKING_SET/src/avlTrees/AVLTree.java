...
public class AVLTree<T extends Comparable<T>> {
    ...
    */
    ...
    /**
     * Adds an element to the tree. By calling the recursive and private method add(AVLNode<T> root, T element),
     * that will return the top node of the tree.
    ...
    /**
    * Recursive add method. If the root given is null it will create a new AVLNode assigning the value of the node
    ...
    */
    ...
    /**
     * toString private recursive method. While the root is different from null the method will continue
     * traversing the tree and adding the nodes to the StringBuilder.
     * Instead of String concatenation it uses StringBuilder because
     * as it is a recursive method we improve the performance.
     * 
     * @param root
    ...
    /**
     * Get the maximum value in the tree. Calls the recursive and private
     * method T getMax(AVLNode<T> root). 
     * 
    ...
    /**
     * Private and reflexive getMax Method, gets the maximum value in the tree by means of recursion.
    ...
    /**
     * Recursive method to traverse the tree from a given root. It travels
     * in order as left + root + right. Null leaves will be represented as "-"
     * 
    ...
    /**
     * Travels the Tree in post-order, that is: leftSubTtree + rightSubTree + root.
     * Null leaves will be represented as "-"
     * 
     * @return the result of travelling all the tree in post-order from the top root.
     */
    ...
    /**
     * Recursive method to traverse the tree from a given root. It travels
     * in post-order as left + right + root. Null leaves will be represented as "-"
     * 
     * @param root of the tree or subtree.
     * @return an String containing all the traverse path.
     */
